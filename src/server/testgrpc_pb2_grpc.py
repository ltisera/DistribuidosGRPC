...
import testgrpc_pb2 as testgrpc__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in testgrpc_pb2_grpc.py depends on'
...
def add_PropioServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'helloworld.Propio', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('helloworld.Propio', rpc_method_handlers)
